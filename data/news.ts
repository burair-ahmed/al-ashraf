...
export const newsItems: NewsItem[] = [
  {
    ...
    title: "Al-Ashraf GOC Breaks Ground on North Nazimabad Mixed-Use Plaza",
    excerpt:
    ...
    content: `Al Ashraf Group of Companies (Al-Ashraf GOC) celebrated a significant milestone today with the groundbreaking ceremony of the North Nazimabad Mixed-Use Plaza — the group's most ambitious construction project to date.
...
"This project represents our commitment to delivering world-class developments right here in Karachi," said Ahmed Ashraf, CEO of Al-Ashraf GOC. "North Nazimabad is a vibrant community, and we are proud to contribute to its continued growth and development."

The plaza will feature state-of-the-art amenities, including basement parking for 300 vehicles, landscaped green spaces, and dedicated retail areas for both local and international brands. Construction is being handled entirely by Al-Ashraf GOC's in-house construction division.`, // TODO: replace with real content
    category: "Construction",
    date: "2025-03-15",
    author: "Al-Ashraf GOC Communications",
    image:
...
"Our goal is to make fresh, high-quality dairy products accessible to every family in Karachi," said Khalid Rehman, Director of the Dairy Products division. "This expansion is a step toward that vision."`, // TODO: replace with real content
  ...
  },
  {
    ...
    content: `Al Ashraf E-commerce has reached a significant operational milestone — 10,000 orders fulfilled since launching the platform. The achievement underscores the rapid adoption of the Al-Ashraf GOC online retail platform by consumers across Karachi and beyond.

The e-commerce division, launched as part of Al-Ashraf GOC's diversification strategy, has seen consistent month-on-month growth since its inception. The platform currently lists over 1,000 products across multiple categories and maintains a customer satisfaction rating of 4.8 out of 5 stars.
...
"Reaching 10,000 orders is validation of the trust our customers place in us," said Sana Malik, Director of E-commerce. "We are committed to continuing to raise the bar on product quality, delivery speed, and customer service."`, // TODO: replace with real content
  ...
  },
  {
    ...
    excerpt:
      "As Al-Ashraf GOC celebrates its 7th founding anniversary, we reflect on seven years of growth, diversification, and community impact across Karachi.",
...
Founded in 2017 by Muhammad Ashraf, the group began as a construction enterprise before expanding into dairy products, e-commerce, and consumer services. Today, Al-Ashraf GOC employs a dedicated workforce across all four divisions, serving hundreds of clients and consumers daily.
...
Al-Ashraf GOC marked the anniversary with internal celebrations and a renewed commitment to its founding values: Strength, Performance, and Passion.`, // TODO: replace with real content
    category: "Company",
    date: "2024-09-01",
    author: "Al-Ashraf GOC Communications",
    image:
